...
build: manifests generate fmt vet ## Build manager binary.
	go build -o bin/manager cmd/system-manager/system-manager.go

build-browser-manager: manifests generate fmt vet ## Build manager binary.
	go build -o bin/browser-manager cmd/browser-manager/browser-manager.go

build-browser-api: manifests generate fmt vet ## Build manager binary.
	go build -o bin/browser-api cmd/browser-api/browser-api.go
...
docker-push: ## Push docker image with the manager.
	$(CONTAINER_TOOL) push ${SYSTEM_MANAGER_IMAGE}

docker-push-browser-api: 
	$(CONTAINER_TOOL) push ${BROWSER_API_IMAGE}
	
docker-push-browser-manager: 
	$(CONTAINER_TOOL) push ${BROWSER_MANAGER_IMAGE}
